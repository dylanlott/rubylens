...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/builds/buildsModule.js',
			'app/modules/builds/buildsCtrl.js',
			'app/modules/builds/buildsRoute.js',
			'app/modules/builds/buildsService.js',
			'app/modules/builds/builds-test.js',
